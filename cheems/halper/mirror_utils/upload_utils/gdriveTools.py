...
from cheems import parent_id, DOWNLOAD_DIR, IS_TEAM_DRIVE, INDEX_URL, \
...
from cheems.halper.ext_utils.fs_utils import get_mime_type, get_path_size
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = 'Mirror cheems Search',
                                 author_name='Mirror cheems',
