from cheems import aria2, download_dict_lock, STOP_DUPLICATE_MIRROR
from cheems.halper.mirror_utils.upload_utils.gdriveTools import GoogleDrivehalper
from cheems.halper.ext_utils.cheems_utils import *
from .download_halper import Downloadhalper
from cheems.halper.mirror_utils.status_utils.aria_download_status import AriaDownloadStatus
...
class AriaDownloadhalper(Downloadhalper):
    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if STOP_DUPLICATE_MIRROR:
          ...
          if smsg:
              ...
              sendMarkup(" Here are the search results:👇👇", dl.getListener().cheems, dl.getListener().update, button)
