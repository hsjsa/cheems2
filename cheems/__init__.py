...
download_dict = {}
# Stores list of users and chats the cheems is authorized to use in
...
try:
    cheems_TOKEN = getConfig('cheems_TOKEN')
...
app = Client(':memory:', api_id=int(TELEGRAM_API), api_hash=TELEGRAM_HASH, cheems_token=cheems_TOKEN)
...
updater = tg.Updater(token=cheems_TOKEN)
cheems = updater.cheems
